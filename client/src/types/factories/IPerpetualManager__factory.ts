    ...
    outputs: [
      {
        ...
        internalType: "struct IPerpetualTreasury.WithdrawRequest[]",
        name: "",
        type: "tuple[]",
      },
    ],
...
export class IPerpetualManager__factory {
  ...
  static createInterface(): IPerpetualManagerInterface {
    return new utils.Interface(_abi) as IPerpetualManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPerpetualManager {
    return new Contract(address, _abi, signerOrProvider) as IPerpetualManager;
  }
}
